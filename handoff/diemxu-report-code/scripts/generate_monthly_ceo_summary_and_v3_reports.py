...
</div><div class="footer"><div style="display:flex;justify-content:space-between;gap:16px;align-items:center"><div><b>DONAPHARM – Hệ thống báo cáo điều hành bán hàng nội bộ</b><br>Developed by Donapharm • CÔNG TY CỔ PHẦN DONAPHARM<br>MST: 3603611886<br>CEO: Đặng Xuân Trung • Website: donapharm.vn<br><span class="small">Email chỉ dùng nội bộ, vui lòng không chuyển tiếp ra ngoài nếu chưa được phép.</span></div><img class="qr" src="cid:qr_zalo" alt="Zalo OA"></div></div>
</div></body></html>'''

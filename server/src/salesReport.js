...
async function main() {
  ...
  if (cmd === 'sample') {
    ...
    console.log(JSON.stringify({ files: r.files, ceoEmail: r.ceoEmail, sendResults: r.sendResults, ranges: r.ranges, cstRows: r.week.data.cstRows.length }, null, 2));
    return;
  }

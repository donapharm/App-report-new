...
test('ghép đúng tên thuốc, hoạt chất, hàm lượng, ĐVT và đơn giá theo khóa đơn vị + QLNB', () => {
  ...
  const enriched = catalogManagement.enrichRowsFromCatalog(rows, [{ c7: 'DV01', c5: 'QL01', c15: 'Hoạt chất A', c16: 'Thuốc A', c17: '500 mg', c25: 'Hộp', c31: 98765 }]);
  assert.deepEqual(
    { product_name: enriched[0].product_name, active_ingredient: enriched[0].active_ingredient, strength: enriched[0].strength, uom: enriched[0].uom, bid_price: enriched[0].bid_price },
    { product_name: 'Thuốc A', active_ingredient: 'Hoạt chất A', strength: '500 mg', uom: 'Hộp', bid_price: 98765 },
  );
});

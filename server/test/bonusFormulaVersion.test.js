...
const FORMULA_SOURCES = ['src/employeeBonus.js', 'src/employeeBonusPolicy.js'];
const FORMULA_CONFIG_KEYS = ['base', 'baseTiers', 'priorityThresholdPct', 'priorityRates', 'autoGroupTargets', 'totalCapPct'];

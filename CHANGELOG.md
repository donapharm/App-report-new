...
- QA: targeted `employeeCost` + `employeeCostVisibility` **31/31 PASS**; full test chạy tuần tự **230/230 PASS**; production build PASS; bundle secret scan PASS. Snapshot App Report T07 hiện chỉ có **1** khóa Cerecaps DN001 (`038.PKĐK THIỆN NHÂN-CN2`, doanh thu 7.980.000đ), nên nghiệm thu số thật “3 dòng Cerecaps” còn chờ nguồn doanh thu App Report có đủ 3 khóa. Thay đổi chỉ nằm trên nhánh review, **chưa deploy**.

### 2026-07-24 — Report Bot — UI KPI Điểm/Xu/Thưởng/Phạt #170 (đã làm, chưa deploy)
...
- **Gate:** web **57/57**, focused **6/6**, Vite production build, `git diff --check`, frontend secret/forbidden-field scan đều PASS. **Chưa deploy UI**; chờ CEO duyệt deploy riêng.

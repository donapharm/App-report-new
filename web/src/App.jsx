...
import CostBreakdown from './pages/CostBreakdown.jsx';
...
const TABS = [
  ...
  { key: 'costBreakdown', label: 'Tổng hợp CP', full: 'Tổng hợp chi phí C33 · C46', ic: '📊', C: CostBreakdown, ceoOnly: true },
...
export default function App() {
  ...
  // VP018 chỉ có hai tab doanh thu + Cơ số thầu và không có công tắc privacy.
  // Hiện số thật trong đúng phiên giới hạn; khi rời phiên khôi phục mặc định che số.
  useEffect(() => {

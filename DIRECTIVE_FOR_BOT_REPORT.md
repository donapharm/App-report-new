...
> File này là **mệnh lệnh/đề xuất** từ phiên Claude đã build App Report New, gửi cho bot report (hoặc bất kỳ phiên Claude nào) làm tiếp. Đọc `CLAUDE.md` + `HANDOFF.md` trước, rồi theo đúng chỉ thị dưới đây.

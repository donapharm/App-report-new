...
## Chuẩn UI desktop (CEO chốt 2026-07-02, cập nhật 2026-08-08)
- **Trang "Phân tích" là CHUẨN MẪU bố cục PC:** hàng thẻ KPI ngang trên cùng → các panel nhiều cột (2–3 cột) tận dụng chiều ngang, trong khung `.page-desktop` **~96% chiều ngang** căn giữa.
- **Bảng dài: tối đa 50 dòng/trang**; bảng rộng hơn màn PHẢI có thanh kéo ngang trong bảng — cấm `overflow` cắt cụt cột lặng lẽ.
